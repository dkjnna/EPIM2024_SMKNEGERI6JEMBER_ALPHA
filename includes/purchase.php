...
<div class="modal" id="purchase" style="font-family: 'League';">
...
<span onclick="openmodal('purchase',false)" style="cursor: pointer; font-size: 30px; font-weight: 600; top: 12px; left: 20px; position: relative; color:#fff; padding: 10px;">x</span>
